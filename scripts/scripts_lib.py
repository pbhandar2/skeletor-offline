...
def get_percentiles(hit_rate_array, max_hit_rate, percentiles):
    ...
    raise Exception("Please check the parameters to the function get_percentiles, \
...
def process_reuse_distance_file(input_file_name, input_dir, output_dir, chunk_size=-1):
